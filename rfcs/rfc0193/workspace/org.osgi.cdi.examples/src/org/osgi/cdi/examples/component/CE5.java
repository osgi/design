...
public class CE5 {
	...
	void observeWithCustomizer(@Observes @Reference ReferenceEvent<ReferenceServiceObjects<Foo>> event) {
	...
	void observeWithCallbacks(@Observes @Reference ReferenceEvent<ReferenceServiceObjects<Foo>> event) {

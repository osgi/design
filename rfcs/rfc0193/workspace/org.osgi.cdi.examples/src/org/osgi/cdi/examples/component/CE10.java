...
public class CE10 {
	...
	void observeWithCustomizer(@Observes @Greedy @Reference(service = Foo.class) ReferenceEvent<Map<String, ?>> event) {
	...
	void observeWithCallbacks(@Observes @Greedy @Reference(service = Foo.class) ReferenceEvent<Map<String, ?>> event) {

...
public class CE8 {
	...
	void observeWithCustomizer(@Observes @Reference @Prototype ReferenceEvent<ReferenceServiceObjects<Foo>> event) {
	...
	void observeWithCallbacks(@Observes @Reference @Prototype ReferenceEvent<ReferenceServiceObjects<Foo>> event) {

...
public class CE12 {
	...
	void observeWithCustomizer(@Observes @Greedy @Reference ReferenceEvent<Map.Entry<Map<String, ?>, Foo>> event) {
	...
	void observeWithCallbacks(@Observes @Greedy @Reference ReferenceEvent<Map.Entry<Map<String, ?>, Foo>> event) {
